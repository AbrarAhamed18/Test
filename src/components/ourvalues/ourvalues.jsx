        ...
        <div className="outerBox">
            ...
            <div className="firstContainer">
                <div className="leftText">
                    <h1 className='Explore'>Explore <br/>
                    Together.</h1>
                ...
                <div className="rightpic">
                    <img className='rpic1' src={rimg1} alt="" />
                </div>
            </div>
            <div className="secondContainer">
                <div className="leftpic">
                <img className='rpic1' src={limg1} alt="" />
...
Assessing our ideas through high-speed testing, and receiving feedback as fast and often as we can is paramount at Madbox. Quick failure and iteration is always preferred to long-drawn-out discussions.</p>                    
            ...
            <div className="thirdContainer">
                <div className="leftText">
                    <h1 className='Be'>Be Thoughtfully Candid.</h1>
                ...
                <div className="rightpic">
                    <img className='rpic1' src={rimg2} alt="" />
                </div>
            </div>
            <div className="fourthContainer">
                <div className="leftpic">
                <img className='rpic1' src={limg2} alt="" />
